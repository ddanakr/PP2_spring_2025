...
class Coin(pygame.sprite.Sprite):
        ...
        def generate_rand_rect(self):
              ...
              self.rect.bottom = 0
              self.rand_weight = random.randrange(100, 500, 100) #setting random weight to coin
...
health_counter = font3.render(f"health: {health}", True, "red")
heakth_counter_rect = health_counter.get_rect(center = (WIDTH - 100, 52))
...
while running:
        ...
        health_counter = font3.render(f"health: {health}", True, "red")
        screen.blit(health_counter, heakth_counter_rect)
        ...
        if pygame.sprite.spritecollideany(player, coin_sprites):
               ...
               earned_coins += coin.rand_weight #increase score
              ...
              # increasing enemy's speed
               if earned_coins % 500 == 0 and earned_coins != 0:
                      if ENEMY_SPEED < 20:
                             ENEMY_SPEED += 1
